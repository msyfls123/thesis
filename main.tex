...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \encovertitle{Research of Visual Interaction Design Theories and Application Based on Panorama Roaming Technology}
  ...
  % 英文封面内容
  \entitle{Research of Visual Interaction Design Theories\\and Application Based on Panorama Roaming Technology}
  \enauthor{Shenyan Ma}
  \enmajor{Design Specialist}
  \enadvisor{A/Prof. Ye Zhou}
...
\else
  ...
  % 摘要
  \input{chapter/abstract2}%此文件中含有中英文摘要
	% 目录
	\tableofcontents
	%默认表格、插图、算法索引名称分别为“表格索引”、“插图索引”和“算法索引”
	%如果需要自行修改lot，lof，loa的名称，请定义
